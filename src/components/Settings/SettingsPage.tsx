...
import { getSystemFonts, selectFolderDialog, saveHeadings } from '../../lib/tauri-api';
...
const SettingsPage: React.FC<SettingsPageProps> = ({
  ...
  const [activeTab, setActiveTab] = React.useState<
    'theme' | 'appearance' | 'editor' | 'save' | 'headings'
  >('appearance');
          ...
          <section className="settings-section">
            ...
            <div className="setting-item">
              <div className="setting-control">
                ...
                />
                <label htmlFor="typewriter-mode">
                  タイプライタースクロール（常に中央にカーソルを維持）
                </label>
              </div>
            </div>
            ...
            <div className="setting-item">
              <div className="setting-control">
                ...
                />
                <label htmlFor="show-ruby-toolbar">
                  ルビ・傍点ツールボタンをツールバーに表示する
                </label>
              </div>
            </div>
            ...
            <div className="setting-item">
              <div className="setting-control">
                ...
                />
                <label htmlFor="show-markdown-toolbar">
                  Markdownツールボタンをツールバーに表示する
                </label>
              </div>
            </div>
          ...
          <section className="settings-section">
            ...
            <div className="setting-item">
              <div className="setting-control">
                ...
                />
                <label htmlFor="restore-last-file">
                  起動時に前回編集していたファイルを読み込む
                </label>
              </div>
              <div className="setting-description">
                ...
                onChange={async (e) => {
                  ...
                  try {
                    ...
                    if (
                      ...
                      parsed.every(
                        (p: any) => p && typeof p.head === 'string' && typeof p.level === 'number'
                      )
                    ) {
                ...
                >
                  <button
                    ...
                    onClick={async () => {
                      ...
                      await saveHeadings(newHeadings);
